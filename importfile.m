...
%
% Example:
%   Data = importfile('Data.csv', 2, 290);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/07/18 16:11:32
...
% format string.
try
    dates{1} = datetime(dataArray{1}, 'Format', 'dd/MM/y', 'InputFormat', 'dd/MM/y');
catch
    try
...
Data = table;
Data.Date = dates{:, 1};
Data.SPXindex = cell2mat(rawNumericColumns(:, 1));
Data.USindex = cell2mat(rawNumericColumns(:, 2));
